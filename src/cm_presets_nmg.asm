...
cm_nmg_esc_big_room:
    %cm_preset("Big Room", preset_nmg_esc_big_room)
...
cm_nmg_esc_secret_passage:
    %cm_preset("Secret Passage", preset_nmg_esc_secret_passage)
...
cm_nmg_east_big_chest_room:
    %cm_preset("Big Chest Room", preset_nmg_east_big_chest_room)
...
cm_nmg_desert_pre_cannonball_room:
    %cm_preset("Cannonball Room", preset_nmg_desert_pre_cannonball_room)
...
cm_nmg_presets_atower:
    ...
    dw cm_nmg_aga_tower_entrance
    dw cm_nmg_aga_dark_room_of_despair
    dw cm_nmg_aga_dark_room_of_melancholy
    dw cm_nmg_aga_red_spears
    dw cm_nmg_aga_circle_of_pot
...
cm_nmg_aga_tower_entrance:
    %cm_preset("Entrance", preset_nmg_aga_tower_entrance)
...
cm_nmg_aga_red_spears:
    %cm_preset("Red Spears", preset_nmg_aga_red_spears)

cm_nmg_aga_circle_of_pot:
    %cm_preset("Circle of Pot", preset_nmg_aga_circle_of_pot)
...
cm_nmg_pod_main_hub:
    %cm_preset("Main Hub", preset_nmg_pod_main_hub)
...
cm_nmg_thieves_getting_flute:
    %cm_preset("Getting Flute", preset_nmg_thieves_getting_flute)
...
cm_nmg_thieves_fire_room:
    %cm_preset("Fire Room", preset_nmg_thieves_fire_room)
...
cm_nmg_sw_got_tempered:
    %cm_preset("Got Tempered", preset_nmg_sw_got_tempered)
...
cm_nmg_presets_swamp:
    ...
    dw cm_nmg_swamp_first_key
    dw cm_nmg_swamp_main_hub
    dw cm_nmg_swamp_switch_room
...
cm_nmg_swamp_first_key:
    %cm_preset("Tiny Hallway Key", preset_nmg_swamp_first_key)

cm_nmg_swamp_main_hub:
    %cm_preset("Main Hub", preset_nmg_swamp_main_hub)

cm_nmg_swamp_switch_room:
    %cm_preset("Switch Room", preset_nmg_swamp_switch_room)
...
cm_nmg_presets_mire:
    ...
    dw cm_nmg_mire_mire_darkworld_warp
    dw cm_nmg_mire_mire_entrance
    dw cm_nmg_mire_mire2
    dw cm_nmg_mire_left_dash
    dw cm_nmg_mire_sluggulas
    dw cm_nmg_mire_spark_gamble
    dw cm_nmg_mire_spike_key
    dw cm_nmg_mire_basement
    dw cm_nmg_mire_cane_dash
    dw cm_nmg_mire_bombable_wall
...
cm_nmg_mire_mire_darkworld_warp:
    %cm_preset("Mire Overworld Screen", preset_nmg_mire_mire_darkworld_warp)

cm_nmg_mire_mire_entrance:
    %cm_preset("Mire Entrance", preset_nmg_mire_mire_entrance)

cm_nmg_mire_mire2:
    %cm_preset("Mire 2", preset_nmg_mire_mire2)

cm_nmg_mire_left_dash:
    %cm_preset("Beat the Fireball", preset_nmg_mire_left_dash)
...
cm_nmg_mire_cane_dash:
    %cm_preset("Cane Dash", preset_nmg_mire_cane_dash)

cm_nmg_mire_bombable_wall:
    %cm_preset("Bombable Wall", preset_nmg_mire_bombable_wall)
...
cm_nmg_trock_lanterns:
    %cm_preset("Torches", preset_nmg_trock_lanterns)
...
cm_nmg_trock_roller_key:
    %cm_preset("Roller Key", preset_nmg_trock_roller_key)

cm_nmg_trock_lazer_skip:
    %cm_preset("Lazer Skip", preset_nmg_trock_lazer_skip)
...
cm_nmg_gtower_gauntlet:
    %cm_preset("Gauntlet", preset_nmg_gtower_gauntlet)
...
cm_nmg_ganon_pyramid_magic:
    %cm_preset("Ganon (magic)", preset_nmg_ganon_pyramid_magic)

; BOSS

cm_nmg_presets_goto_bosses:
    %cm_submenu("Bosses", cm_nmg_presets_bosses)

cm_nmg_presets_bosses:
    dw cm_nmg_east_armos
    dw cm_nmg_desert_lanmolas
    dw cm_nmg_hera_moldorm
    dw cm_nmg_aga_agahnim
