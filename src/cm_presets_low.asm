...
cm_low_esc_big_room:
    %cm_preset("Big Room", preset_low_esc_big_room)
...
cm_low_esc_secret_passage:
    %cm_preset("Secret Passage", preset_low_esc_secret_passage)
...
cm_low_east_big_chest_room:
    %cm_preset("Big Chest Room", preset_low_east_big_chest_room)
...
cm_low_desert_pre_cannonball_room:
    %cm_preset("Cannonball Room", preset_low_desert_pre_cannonball_room)
...
cm_low_presets_atower:
    ...
    dw cm_low_aga_tower_entrance
    dw cm_low_aga_dark_room_of_despair
    dw cm_low_aga_dark_room_of_melancholy
    dw cm_low_aga_red_spears
    dw cm_low_aga_circle_of_pot
...
cm_low_aga_tower_entrance:
    %cm_preset("Entrance", preset_low_aga_tower_entrance)
...
cm_low_aga_red_spears:
    %cm_preset("Red Spears", preset_low_aga_red_spears)

cm_low_aga_circle_of_pot:
    %cm_preset("Circle of Pot", preset_low_aga_circle_of_pot)
...
cm_low_pod_main_hub:
    %cm_preset("Main Hub", preset_low_pod_main_hub)
...
cm_low_thieves_getting_flute:
    %cm_preset("Getting Flute", preset_low_thieves_getting_flute)
...
cm_low_thieves_fire_room:
    %cm_preset("Fire Room", preset_low_thieves_fire_room)
...
cm_low_sw_got_tempered:
    %cm_preset("Got Tempered", preset_low_sw_got_tempered)
...
cm_low_presets_swamp:
    ...
    dw cm_low_swamp_first_key
    dw cm_low_swamp_main_hub
    dw cm_low_swamp_switch_room
...
cm_low_swamp_first_key:
    %cm_preset("Tiny Hallway Key", preset_low_swamp_first_key)

cm_low_swamp_main_hub:
    %cm_preset("Main Hub", preset_low_swamp_main_hub)

cm_low_swamp_switch_room:
    %cm_preset("Switch Room", preset_low_swamp_switch_room)
...
cm_low_presets_mire:
    ...
    dw cm_low_mire_mire_darkworld_warp
    dw cm_low_mire_mire_entrance
    dw cm_low_mire_mire2
    dw cm_low_mire_left_dash
    dw cm_low_mire_sluggulas
    dw cm_low_mire_spark_gamble
    dw cm_low_mire_spike_key
    dw cm_low_mire_basement
    dw cm_low_mire_cane_dash
    dw cm_low_mire_bombable_wall
...
cm_low_mire_mire_darkworld_warp:
    %cm_preset("Mire Overworld Screen", preset_low_mire_mire_darkworld_warp)

cm_low_mire_mire_entrance:
    %cm_preset("Mire Entrance", preset_low_mire_mire_entrance)

cm_low_mire_mire2:
    %cm_preset("Mire 2", preset_low_mire_mire2)

cm_low_mire_left_dash:
    %cm_preset("Beat the Fireball", preset_low_mire_left_dash)
...
cm_low_mire_cane_dash:
    %cm_preset("Cane Dash", preset_low_mire_cane_dash)

cm_low_mire_bombable_wall:
    %cm_preset("Bombable Wall", preset_low_mire_bombable_wall)
...
cm_low_trock_lanterns:
    %cm_preset("Torches", preset_low_trock_lanterns)
...
cm_low_trock_roller_key:
    %cm_preset("Roller Key", preset_low_trock_roller_key)

cm_low_trock_lazer_skip:
    %cm_preset("Lazer Skip", preset_low_trock_lazer_skip)
...
cm_low_gtower_gauntlet:
    %cm_preset("Gauntlet", preset_low_gtower_gauntlet)
...
cm_low_ganon_pyramid_magic:
    %cm_preset("Ganon (magic)", preset_low_ganon_pyramid_magic)

; BOSS

cm_low_presets_goto_bosses:
    %cm_submenu("Bosses", cm_low_presets_bosses)

cm_low_presets_bosses:
    dw cm_low_east_armos
    dw cm_low_desert_lanmolas
    dw cm_low_hera_moldorm
    dw cm_low_aga_agahnim
