...
db $18 ;Snakebasket
db $18 ;Blobs?
db $18 ;Metal Balls (in Eastern Palace)
db $51 ;Armos
db $52 ;Zora King
db $53 ;Armos Knight
db $54 ;Lanmolas boss
...
db $5B ;Spark (clockwise on convex)
db $5C ;Spark (counterclockwise on convex)
...
db $70 ;Splitting Fireballs from Helmasaur King
db $18 ;Leever
...
db $18 ;Green Stalfos
db $7D ;32*32 Pixel Yellow Spike Traps
db $7E ;Swinging Fireball Chains
db $7F ;Swinging Fireball Chains
db $80 ;Wandering Fireball Chains
db $18 ;Waterhoppers
...
db $94 ;Pirogusu (aka Swimmer) / Flying Tiles
db $95 ;Eye laser
db $96 ;Eye laser
db $97 ;Eye laser
db $98 ;Eye laser
...
db $18 ;Black sperm looking things
db $9E ;Ostrich seen with Flute Boy
db $9F ;Rabbit seen with Flute Boy
db $A0 ;Birds seen with Flute Boy
db $18 ;Freezor
db $A2 ;Kholdstare
db $A3 ;Another part of Kholdstare
db $A4 ;Ice balls from above
...
db $C1 ;Agahnim teleporting Zelda to dark world
...
db $D2 ;Flopping fish
db $D3 ;Stal (Hopping Skull Creatures)
db $D4 ;Landmines
